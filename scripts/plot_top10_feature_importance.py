...
DATASETS = [
    ...
    ("SI206_train_shuffled_test_regular", "multirun_results/SI206_train_shuffled_test_regular_metrics.csv", "multirun_results/SI206_train_shuffled_test_regular_feature_importance.csv"),
    ("SI216_train_shuffled_test_regular", "multirun_results/SI216_train_shuffled_test_regular_metrics.csv", "multirun_results/SI216_train_shuffled_test_regular_feature_importance.csv"),
    ("Combined_train_shuffled_test_regular", "multirun_results/Combined_train_shuffled_test_regular_metrics.csv", "multirun_results/Combined_train_shuffled_test_regular_feature_importance.csv"),
